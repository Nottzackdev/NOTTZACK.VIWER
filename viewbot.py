...
if __name__ == "__main__":
    os.system("cls" if os.name == "nt" else "clear"); os.system("title TikTok Viewbot by @ianntzk" if os.name == "nt" else "")
    txt = """\n
  
  _   _   _______   ______  _  __   __      __  _____  __          __  ______   _____     _____ 
 | \ | | |__   __| |___  / | |/ /   \ \    / / |_   _| \ \        / / |  ____| |  __ \   / ____|
 |  \| |    | |       / /  | ' /     \ \  / /    | |    \ \  /\  / /  | |__    | |__) | | (___  
 | . ` |    | |      / /   |  <       \ \/ /     | |     \ \/  \/ /   |  __|   |  _  /   \___ \ 
 | |\  |    | |     / /__  | . \       \  /     _| |_     \  /\  /    | |____  | | \ \   ____) |
 |_| \_|    |_|    /_____| |_|\_\       \/     |_____|     \/  \/     |______| |_|  \_\ |_____/  """
    print(
        Colorate.Vertical(
    ...
    try:
        ...
        input(Col.red + "x - Has puesto algo Incorrecto Intentalo de nuevo" + Col.reset)
        sys.exit(0)
